...
footer: Advanced Modeling & Simulation (AMS) Seminar Series &nbsp;&nbsp; <img width="5%" src="figures/by-sa.png"/> &nbsp;&nbsp;  NASA Ames Research Center, July 29th, 2025
...
:::{.row .text-center .align-items-center .my-4}
::::{.col}
...
"Practical" approach by [Harten, '95], [Cohen et al., '03], [Duarte et al., '11-'16].
...
{{< include python_sections/sol_level_MR_order03_eps1e-5.qmd >}}

---

## Burgers results (MR solution and error for scheme order 3)

{{< include python_sections/sol_error_MR_order03_eps1e-5.qmd >}}

---

## Burgers results (MR+MLF sol. and level for scheme order 3)

{{< include python_sections/sol_level_MR_MLF_order03_eps1e-5.qmd >}}

---

## Burgers results (MR+MLF sol. and error for scheme order 3)

{{< include python_sections/sol_error_MR_MLF_order03_eps1e-5.qmd >}}
...
- Mathematical modeling and simulation of non-equilibrium plasmas for the prediction of electric propulsion and discharges 
- Code coupling : multistep coupling algorithm (Tuesday's seminar) - 
- Two-phase flows two-scale modeling 
- Mesh adaptation / Multiresolution analysis - new generation of ImEx schemes for reactive flows
- Rarefied flows 
